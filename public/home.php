  ...
  <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="/book/process/logoutProcess.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <div class="p-4 border-2 border-gray-200  rounded-lg dark:border-gray-700">
      <div class="gap-1 mb-4">
        <div class="flex items-center justify-between h-24 rounded bg-gray-50 dark:bg-gray-800">
          ...
          <div class="welcome">
            <h1 class="font-extrabold   text-xl md:text-4xl">
              KMJ BOOKSHOP
            </h1>
          </div>
      ...
      <div class="flex items-center justify-center h-96 mb-20 rounded bg-gray-50 dark:bg-gray-800">
        <div class="container ">
    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
        <div>
          ...
          <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">New Items</h2>
        </div>
      ...
      <div class="relative h-full w-full max-w-xl md:h-auto">
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
          ...
          <div class="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
            ...
            <script src="https://cdn.jsdelivr.net/npm/flowbite@2.5.2/dist/flowbite.min.js"></script> </div>
        </div>
      </div>
    </form>
  </section>
